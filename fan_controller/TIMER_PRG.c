...
void TIMER2_Set_Time_uS (u16 Copy_U8Time)
{
	DESIRED_TIME_TIMER2 = Copy_U8Time ;                         //time in ms
    T_OV_TIMER2 = (256*(f32)PRE_SCALAR_TIMER2)/8 ;                  //time in us
    if (DESIRED_TIME_TIMER2<T_OV_TIMER2)
    {
    	PRE_LOAD_TIMER2  = NUM_OV_TIMER2-DESIRED_TIME_TIMER2;
    }

    TCNT2=PRE_LOAD_TIMER2;
}
